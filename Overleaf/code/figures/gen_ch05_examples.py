...
def panel(lines, grid, xshift, fills=(), labels=None, paths=(), start=None, goal=None,
    ...
    """One grid panel.  fills: list of (style, cells); paths: list of (style, cells)."""
...
def idea_figure():
    ...
    panel(lines, grid, 8.0, fills=[("sbOrange!35", expanded)],
...
def lpastar_figure():
    ...
    panel(lines, grid, 5.6, fills=lpa_fills(r["state_change"]), labels=lpa_labels(r["state_change"]),
          start=e["start"], goal=e["goal"], title="$(3,1)$ blocked, before the repair",
          font="\\scriptsize")
    panel(lines, grid, 11.2, fills=lpa_fills(r["state_repair"]), labels=lpa_labels(r["state_repair"]),
...
def dstarlite_figure():
    ...
    panel(lines, grid, 7.6, fills=[("sbOrange!45", r["inconsistent"])],
    ...
    panel(lines, grid, 15.2, fills=[("sbclosed", r["expanded"])],
