...
cell, and every interior cell has $3^{3}-1=26$ neighbors in the
...
states, $5.5$~TB at one byte each, and $3^{6}-1=728$ neighbors if all axes
...
toward the sample is $(6.84,2.24)/7.197=(0.9504,0.3112)$, so
...
toward such a sample crosses the wall.
\end{solution}
