...
Iteration~11, $x_{\mathrm{rand}}=(9.70,5.16)$: the distances to vertices~0
to~6 are smallest for vertex~6 at $(2.86,2.92)$, $\norm{x_{\mathrm{rand}}-x_6}=7.197$
(vertex~5 gives $7.424$), so $x_{\mathrm{near}}=x_6$. The unit vector
towards the sample is $(6.84,2.24)/7.197=(0.9504,0.3112)$, so
$x_{\mathrm{new}}=x_6+0.5\,(0.9504,0.3112)=(3.335,3.076)$, which is inside
the wall $[3,5]\times[0,6]$: the extension is rejected. Iteration~12,
$x_{\mathrm{rand}}=(6.23,7.77)$: again vertex~6 is nearest ($5.906$ against
$6.355$ for vertex~5), the unit vector is $(0.5706,0.8212)$ and
$x_{\mathrm{new}}=(3.145,3.331)$, again inside the wall and rejected. Both
lines match the trace printed by \code{ch16\_rrt.py}. The Voronoi picture
