...
moving on. Over twelve weeks that is roughly 75--95 hours in total, which is what you
...
trajectories that Week~10 learns from. Notice that four arrows leave Week~1 and Week~3: a
bug carried out of those two weeks reappears three times, which is why
