...
disc whose radius is the sum of the two radii. The velocity obstacle (VO) written $\VO^{\ttc}_{A|B}$ without an
argument (\cref{ch:ch13}, \cref{def:ch13-vo}) is the set of \emph{relative} velocities
$\vel_{\mathrm{rel}} = \vel_A - \vel_B$ that bring the two discs into contact within the
