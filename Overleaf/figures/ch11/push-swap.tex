...
\begin{scope}[xshift=5.6cm,yshift=0.35cm]
  ...
  \node[sbannot,anchor=north,align=center] at (5.2,-1.35) {(b) swap: at a vertex $v$ of degree $\ge 3$ with two empty neighbours $n_1$, $n_2$,\\ six moves exchange $a$ and $b$ without moving anyone else};
\end{scope}
% ---- (c) rotate ------------------------------------------------------------
