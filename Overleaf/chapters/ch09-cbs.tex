...
written against a constraint set.\index{CBS!low level} Line~\ref{alg:ch09-lowlevel:tgamma}
...
drops the successors that a vertex or edge constraint of
\cref{def:ch09-constraint} forbids. Everything
