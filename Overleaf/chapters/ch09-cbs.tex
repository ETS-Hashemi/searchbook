...
$k = 10$ is larger than at $k = 12$ because it finishes one crowded
instance that plain \cbs abandons: means taken over the solved instances
only are not comparable when the two solvers solve different sets.) Its price is
