...
$12\,\%$. During the first $7.5$ units the drone flies at the speed limit; the
...
with the hybrid potential ($d^* = 2$) gives a trajectory that is
indistinguishable by eye, because the clip has already turned the bowl into
a cone far from the goal.
