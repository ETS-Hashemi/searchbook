...
\begin{itemize}
  ...
  \item Distance to a segment, ray--circle intersection, the Minkowski disc, tangent lines and the time of closest approach $t^*=(\pos_{\mathrm{rel}}\cdot\vel_{\mathrm{rel}})/\norm{\vel_{\mathrm{rel}}}^2$ with $d_{\min}=\abs{\pos_{\mathrm{rel}}\times\vel_{\mathrm{rel}}}/\norm{\vel_{\mathrm{rel}}}$ are the geometry of collision avoidance.
