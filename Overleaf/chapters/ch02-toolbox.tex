...
\midrule
Graph move & vertex $v$ & move or wait & one edge per step & \cref{ch:ch03,ch:ch04,ch:ch05,ch:ch06,ch:ch07,ch:ch08,ch:ch09,ch:ch10,ch:ch11}\\
