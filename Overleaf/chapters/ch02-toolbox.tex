...
Let $\mat{\Sigma}=\mat{E}\mat{\Lambda}\mat{E}\T$ be the eigen-decomposition of a $2\times2$ covariance, with orthonormal eigenvectors $\vect{e}_1,\vect{e}_2$ as the columns of $\mat{E}$ and eigenvalues $\lambda_1\ge\lambda_2>0$. Then $\mathcal{E}_k$ is the ellipse centered at $\vect{\mu}$ with semi-axis $k\sqrt{\lambda_1}$ along $\vect{e}_1$ and $k\sqrt{\lambda_2}$ along $\vect{e}_2$,
\begin{equation}
