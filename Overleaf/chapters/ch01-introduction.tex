...
LSTM trajectory prediction & Learns temporal motion patterns from recorded trajectories; the plan marks it essential for prediction-based research & \priority{Essential} & \cref{ch:ch20}\\
Transformer trajectory prediction & Attention-based alternative for longer horizons and interaction-aware prediction & \priority{Awareness--High} & \cref{ch:ch20}\\
\addlinespace
