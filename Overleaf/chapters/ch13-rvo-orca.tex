...
then postpones the first collision without excluding it. Both agents must
...
show the functions that carry the mathematics, and the line program of
...
then a fixed point of the step of \cref{sec:ch13-step}. (c) Propose two remedies, one
