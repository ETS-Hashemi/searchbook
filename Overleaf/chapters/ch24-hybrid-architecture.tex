...
control cycle of \cref{alg:ch24-loop} line by line; \code{try\_reconnect}
installs the result of \cref{alg:ch24-reconnect} (\code{reconnect} and
\code{segment\_free}), and \code{replan} and \code{recheck} in the file
complete \cref{alg:ch24-replan}.
