...
argument for two discs of \cref{ch:ch02}, the discs overlap at time $t$ if
...
\begin{figure}[tb]
  ...
  $t=1$ and $t=3.6\,\mathrm{s}$ and returns to its preferred velocity once
...
with density: for $n = 2$ and $n = 4$ the runs are clean, at $n = 3$ one pair
grazes ($0.990$), and from $n = 5$ on the minimum distance falls below $R$ at
every density (to $0.914$ for $n=6$, an overlap of $9\,\%$ of the combined
radius), several pairs graze each other, decisions
