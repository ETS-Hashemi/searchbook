...
side (its discriminant is negative). From $t=3.7\,\mathrm{s}$ the agent adds a
...
velocity command chatters between roughly $\pm0.2$ and $0$ at every step. A real
...
experiments of \cref{sec:ch12-experiment}, runs in about $0.3\,\mathrm{s}$;
