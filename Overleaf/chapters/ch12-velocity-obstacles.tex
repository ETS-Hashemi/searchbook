...
whichever is closest. The method \code{VelocityObstacle.closest\_boundary\_point}
in the chapter's code does this in a few lines and returned $\vel^* = (1, 0.1)$ in
...
\code{VelocityObstacle.closest\_boundary\_point} is both cheaper and
better; with many
