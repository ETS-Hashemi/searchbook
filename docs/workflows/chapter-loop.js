...
LENGTH: ${it.essential ? 'this is an ESSENTIAL chapter of the training plan: aim for 16-22 pages of chapter text and use up to 24 if the material needs it' : 'aim for 12-18 pages of chapter text, up to 20 if the material needs it'}. Completeness and accuracy come first: never drop a must-cover item to save space; save space by cutting repetition, redundant examples and over-long prose instead.
